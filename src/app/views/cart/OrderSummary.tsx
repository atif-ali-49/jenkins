...
function OrderSummary() {
    ...
    const[expressCard,setExpressCard] = useState(false);
	...
	const ValidationFields = Yup.object().shape({
			...
			cardNumber:switcher ? Yup.string().required('Card Number is required').min(16,'Enter valid card number'):Yup.string(),
			cvv:switcher ? Yup.string().required('Cvv is Required').min(3,'Enter valid cvv'):Yup.string(),
