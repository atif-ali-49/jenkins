...
useEffect(()=>{
  if(sessionStorage.getItem('rName')){
    setUsername(sessionStorage.getItem('rName'));
    setUser(prevState => ({
      ...prevState,
          ...
          <div className="row align-items-center">
            ...
            <Col md={6}>
              ...
              <Form  onSubmit={onSubmit}>
                ...
                <div className="form-group">                     
                  ...
                  onChange={handleInputChange}
                   />
                    {
                     passlength  &&
                      <span className="help-block font-small-3 text-danger">Password have at least 8 characters</span>
                    }
                  <hr className="login-line"/>
                </div>
                ...
                <p className="text-light text-right mb-3 d-inline float-right"><Link to="/crypto/forget/password">Forgot Password?</Link></p>
