    ...
    return (
        <>
            <MBox className="pageHeader">
                <MTypography className="mainHeading" gutterBottom component="h1" variant="h4">ETH to USD chart</MTypography>
                <RouterBreadcrumbs />
            </MBox>
            <MBox className="contentBox" component={MPaper} minHeight={400}>
                {loading ?
                    <MCircularProgress />
                    :
                    <AdvancedChart widgetProps={{"theme": "light", "symbol": "ETHUSD"}} />
                }
            </MBox>
       </>
    );
