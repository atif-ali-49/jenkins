...
import useStyles from './IboLedgerStyle'
...
function IboLedger() {
	...
	const getIboTransactions = () => {
		setLoading(true);
		axios.get(baseUrl+`/my_smart_pay_package/ibo/${recordsPerPage}?page=${currentPage}`)
		.then(function (res) {
    ...
    return (
        <div>
            <Box className="pageHeader">
				<Typography className="mainHeading" gutterBottom component="h1" variant="h4">Ibo Transactions</Typography>
				<RouterBreadcrumbs />
            </Box>
			{loading ?
