                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-lg-6 mobfooter mt-5">
                            ...
                            <small className="text-danger text-center d-none  errortext">Email Field is Required
                                ...</small>
                        </div>
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        ...
                        <div className="col-lg-2 col-md-6 footer-links">
                            ...
                            <ul>
                                <li><i className="fa fa-angle-right"></i> <NavLink to="/">Home</NavLink></li>
                                <li><i className="fa fa-angle-right"></i> <NavLink to="/about">About Us</NavLink></li>
                                <li><i className="fa fa-angle-right"></i> <NavLink to="/services">Services</NavLink>
                                </li>
                                <li><i className="fa fa-angle-right"></i> <NavLink to="/terms">Terms
                                    &amp;
                                    Refund Policy</NavLink></li>
                                <li><i className="fa fa-angle-right"></i> <NavLink to="/terms">Privacy
                                    Policy</NavLink></li>
                            </ul>
                        </div>
                        ...
                        <div className="col-lg-3 col-md-6 footer-links">
                            ...
                            <ul>
                                <li><i className="fa fa-angle-right"></i> <NavLink to="/services">Jewelry</NavLink>

                                </li>
                                <li><i className="fas fa-angle-right"></i> <NavLink to="/services">Cryptocurrency</NavLink></li>
                                <li><i className="fas fa-angle-right"></i>  <NavLink to="/services">Club Membership</NavLink></li>
                                                      <li>
                                <i className="fas fa-angle-right"></i>

                                                          <NavLink to="/services">Exclusive Membership</NavLink>
                            </li>
                            </ul>
                        </div>
                            ...
                            <p>
                                ...
                                <br></br>
                                    <br></br>
                                        ...
                                        <strong>Email:</strong> support@peacecoin.com<br></br>
                            </p>
                        ...
                        <div className="col-12">
                            <div className="copyright text-warning text-center"  style={{position:'relative'}}>
                                &copy; 2021 Copyright <strong><span><NavLink to="/" className="primary-text">Peacecoin Inc.</NavLink></span></strong> All
                                Rights Reserved
                            </div>
                        </div>
                    </div>
